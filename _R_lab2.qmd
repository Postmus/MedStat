...
You can also use R to calculate this 95% confidence interval using the `qt()` function to determine the appropriate t-value:
...
How does the 95% confidence interval given by R compare to the 95% confidence interval that you manually computed?
:::
