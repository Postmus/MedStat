...
3.  **Part C: Building a Prediction Model:** Build a prediction model for maximum heart rate using backward elimination and assess model assumptions.
...
### **A1.** Research Question & Exploratory Analysis
**Research Question:** *Is there a difference in resting blood pressure between males and females, after accounting for age?*

*   **Visualize the data:** Create a scatterplot of `trestbps` (y-axis) versus `age` (x-axis), using different colors to represent `sex`.
*   **Describe group patterns:** Based on the plot, describe whether males and females appear to have different resting blood pressure levels, and whether those differences seem consistent across ages.
...
*   **Part A (ANCOVA):** Include the scatterplot, report the adjusted male–female difference in `trestbps` (95% CI, p-value), and briefly state what the diagnostic plots and interaction test suggest.
