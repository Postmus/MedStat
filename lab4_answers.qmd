...
* Step 5: Determine the 95% confidence interval
  - $Z_{critical} = 1.96$
  - $\text{Lower bound} = \text{Difference} - Z_{critical} \times \text{SE} = 0.233 - 1.96 \times 0.120 \approx -0.001$
